...
public class CustomerRecordsApiProviderValidationIT extends AbstractApiProviderValidationIT {
    @TestTemplate
    ...
    void before(PactVerificationContext context) {
        ...
        customerClient.customerClientUrl = "http://localhost:" + getProvidersPort();
    }
